...
public class Menu {
    ...
    public static Image getImage(String imageName,double width, double height) {
        return new Image(new File("Scenes/Images/" + imageName + ".jpg").toURI().toString(),width,height,true,true);
    }
